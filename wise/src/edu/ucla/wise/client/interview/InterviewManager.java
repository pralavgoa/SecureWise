...
public class InterviewManager {
    ...
    /**
     * Checks if the InterviewManager class is instantiated, 
     * if yes returns the it else creates a new object and returns it.
     * 
     ...
     * {@link Interviewer}.
     * 
     * @param studySpace 	Study space to which interviewer is related to.
    ...
    public synchronized String getNewId(StudySpace studySpace) {
		...
		try {
		    ...
		    AdminApplication.logError("GET NEW INTERVIEWER ID:" + e.toString(), e);
     ...
     * 
     * @param studySpace 	Study space to which interviewer is related to.
     * @param interviewer 	Interview to be added to the table
    ...
    public synchronized String addInterviewer(StudySpace studySpace,
		...
		try {
		    ...
		    AdminApplication.logError("Add interviewer ID:" + e.toString(), e);
     ...
     * 
     * @param studySpace 	Study space to which interviewer is related to.
     * @param interviewId 	Interviewer ID to assign parameters.
     * 
     * @return Interviewer object
     */
    public Interviewer getInterviewer(StudySpace studySpace,
    		String interviewId) {
