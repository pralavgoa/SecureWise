...
public class ConsentGenerateServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger
	    .getLogger(ConsentGenerateServlet.class);
	...
	if ((theUser == null) || (studySpace == null)
		|| (theUser.getId() == null)) {
	...
	if (pf != null) {
	    if ((theUser.getIrbId() == null)
		    || (theUser.getCurrentSurvey().getId() == null)) {
	    ...
	    ConsentForm consentForm = pf.getConsentFormSurveyIrb(theUser
		    .getCurrentSurvey().getId(), theUser.getId());
	    if (consentForm == null) {
