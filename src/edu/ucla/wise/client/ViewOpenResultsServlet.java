...
/**
 * ViewOpenResultsServlet creates a summary report for each individual open question
 * 
 * @author Douglas Bell
 * @version 1.0  
 */
...
public class ViewOpenResultsServlet extends HttpServlet {
    ...
    /**
     * Displays results of an open question while viewing the results from wise admin page.
     *   
